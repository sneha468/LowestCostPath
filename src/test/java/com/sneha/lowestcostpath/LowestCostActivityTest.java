...
import com.sneha.lowestcostpath.view.LowestCostActivity;
...
@Config(constants = BuildConfig.class, sdk = 21,
        manifest = "src/main/AndroidManifest.xml", packageName = "com.sneha.lowestcostpath")
public class LowestCostActivityTest {
    ...
    public void goButtonIsDisabledByDefault() {
        Button goButton = (Button) getViewFromActivity(R.id.go_button);
